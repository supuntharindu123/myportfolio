...
function Home() {
  ...
  const skillsData = [
    { name: "HTML", icon: HTML, progress: 95 },
    { name: "CSS", icon: CSS, progress: 90 },
    { name: "JavaScript", icon: Js, progress: 85 },
    { name: "React", icon: Reactimg, progress: 88 },
    { name: "Node.js", icon: Nodejs, progress: 80 },
    { name: "Python", icon: Python, progress: 92 },
    { name: "Django", icon: Django, progress: 85 },
    { name: "SQLite", icon: Sqlite, progress: 78 },
    { name: "MySQL", icon: Mysql, progress: 82 },
    { name: "MongoDB", icon: MongoDb, progress: 75 },
    { name: "Tailwind CSS", icon: Tailwind, progress: 90 },
    { name: "Bootstrap", icon: Bootstrap, progress: 88 },
    { name: "Kotlin", icon: Kotlin, progress: 70 },
    { name: "Socket.io", icon: Socket, progress: 65 },
  ];
        ...
        <div className="bg-gray-300 dark:bg-slate-800">
          <div className="flex flex-col items-center justify-center h-auto lg:flex-row ">
            <div className="flex flex-col justify-center m-6 lg:items-center lg:-mr-80 lg:ml-[200px]">
              <h1 className="text-4xl font-extrabold text-black sm:text-5xl md:text-6xl lg:text-6xl xl:text-8xl dark:text-white animate-bounce">
                Welcome !
              </h1>
              <h2 className="my-4 text-2xl font-bold sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl dark:text-white lg:text-center">
                I'm Supun Tharindu Kumarasena
              </h2>
              <h3 className="text-lg sm:text-xl md:text-2xl dark:text-white lg:text-center">
                Undergraduate at SLIIT &nbsp;|&nbsp; BScIT(Hons) &nbsp;|&nbsp;
                Specialized in Information Technology&nbsp;
              </h3>
              <div className="flex flex-row items-center mt-8 lg:justify-center">
                <a
                  href=""
              ...
              <button className="w-48 px-8 py-2 mt-6 text-lg font-semibold border-2 border-gray-500 shadow sm:px-16 sm:text-2xl sm:w-80 dark:border-white rounded-xl dark:text-white hover:bg-slate-600 hover:text-white">
            ...
            <div className="flex flex-row items-center justify-center lg:ml-[300px]">
              <img
                src={Me}
          ...
          >
            ...
            <div className="lg:w-[50%] flex flex-col justify-center">
              ...
              <a
                href="#contact"
                className="w-64 px-8 py-3 mt-8 ml-10 text-xl font-bold text-center text-white transition-colors duration-300 border rounded-lg shadow-lg border-slate-900 dark:bg-slate-800 lg:-ms-24 hover:bg-slate-950 bg-sky-800 hover:border-white"
              >
                Let's Connect!
              </a>
            </div>
          ...
          >
            <div className="lg:w-[50%] justify-center flex items-center">
              <h1 className="items-center justify-center mt-10 text-4xl font-extrabold text-center sm:text-5xl md:text-5xl xl:text-8xl lg:text-5xl dark:text-white text-slate-800">
            ...
            <div className="flex flex-col items-center justify-center lg:mr-16 lg:flex-row xl:-ml-20 md:flex-row">
              <div className="justify-center pb-6 m-6 bg-gray-300 border-4 rounded-md shadow-lg shadow-slate-400 dark:shadow-slate-200 w-80 hover:border-slate-400 hover:shadow-none dark:bg-slate-800">
              ...
              <div className="justify-center pb-6 m-6 bg-gray-300 border-4 rounded-md shadow-lg shadow-slate-400 dark:shadow-slate-200 w-80 hover:border-4\slate-400 dark:bg-slate-800 hover:shadow-none  ">
          ...
          <div className="flex flex-col items-center justify-center pb-10 bg-gray-200 dark:bg-slate-800 xl:flex-row">
            <div className="flex flex-col items-center justify-center lg:mr-16 lg:flex-row md:flex-row">
              <div className="justify-center pb-6 m-6 bg-gray-300 border-4 rounded-md shadow-gray-400 shadow-lg dark:*:shadow-slate-200 w-80 hover:border-slate-400 hover:shadow-none dark:bg-slate-800">
                <img src={Test} className="rounded-md w-80 h-52"></img>
                <div className="h-16 px-3 mt-2 text-2xl font-bold text-center dark:text-white">
            ...
            <div className="flex flex-col items-center justify-center bg-gray-200 lg:mr-16 lg:flex-row xl:-ml-12 md:flex-row dark:bg-slate-800">
              <div className="justify-center pb-6 m-6 bg-gray-300 border-4 rounded-md shadow-lg shadow-slate-400 dark:shadow-slate-200 w-80 hover:border-slate-400 dark:bg-slate-800 hover:shadow-none">
              ...
              <div className="justify-center pb-6 m-6 bg-gray-300 border-4 rounded-md shadow-lg shadow-slate-400 dark:shadow-slate-200 w-80 hover:shadow-none dark:bg-slate-800 hover:border-slate-400">
                <img src={Test} className="rounded-md w-80 h-52"></img>
                <div className="h-16 px-3 mt-2 text-2xl font-bold text-center dark:text-white">
                  Task Management App
                </div>
          ...
          >
            <div className="lg:w-[40%] justify-center flex animate-slide-in">
              <h1 className="text-4xl font-extrabold text-center sm:text-5xl md:text-6xl lg:text-8xl dark:text-white text-slate-800 lg:ml-60">
            ...
            <div className="lg:w-[60%] flex flex-wrap justify-center pr-6 lg:mr-40 animate-fade-in">
              {skillsData.map((skill, index) => (
                <div
                  key={index}
                  className="relative m-5 transition-transform duration-300 transform group hover:scale-110"
                >
                  <img
                    src={skill.icon}
                    alt={skill.name}
          ...
          >
            <div className="lg:w-[50%] justify-center flex flex-col items-center">
              <h1 className=" shadow-slate-900 text-gray-800 font-extrabold text-4xl sm:text-5xl md:text-6xl xl:text-8xl lg:text-7xl dark:text-white lg:w-[30%] text-center lg:mr-56 xl:mr-88">
                Contact
              </h1>
              <div className="flex flex-col justify-start ">
                <p className="max-w-md mt-6 text-xl text-center text-gray-600 lg:text-start dark:text-gray-300">
                  Have a question or want to work together? Feel free to reach
                  out!
                </p>

                <div className="flex justify-center mt-8 space-x-6 lg:justify-start">
                  <a
            ...
            <div className="lg:w-[40%] w-[80%] mt-6">
              <form className="p-6 bg-white border shadow-xl shadow-grey-500 lg:-ml-24 lg:mr-24 dark:bg-slate-700 rounded-xl">
                <div className="mb-10">
                  <label
